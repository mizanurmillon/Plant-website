...
sr.reveal(`.home__data, .about__top, .popular__top, .review__top, .review__swiper, .footer__content, .footer_icon, .copy__right`)
sr.reveal(`.home__img`, {delay: 500 , scale: 0.5})

sr.reveal(`.service__cart, .popular__cart`, {interval: 100})
